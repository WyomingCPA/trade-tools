...
class GetCandleHourEtf extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:get-hour-candle-etf';
     ...
     * @var string
     */
    protected $description = 'Get Candle Hour for Etf';
    ...
    public function handle()
    {
        ...
        $stocks = Etf::whereIn('id', $favorite_ids)->orderBy('updated_at')->get();
                ...
                try {
                    $model = Candle::firstOrCreate(
                        ...
                        [
                            ...
                            'time' => $candle->getTime() ? $candle->getTime() : 'no',
